...
extern unsigned long publishInterval;  //intervalo de publicacion del dato //60 segundos por default//
...
void actualizarLED() {
  ...
  // Si esta en modo configuracion (AP) → no tocamos nada (ya se maneja en loop del AP)
